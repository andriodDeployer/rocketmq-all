    ...
    private SendResult sendDefaultImpl(
        ...
        if (topicPublishInfo != null && topicPublishInfo.ok()) {
            ...
            for (; times < timesTotal; times++) {
                ...
                MessageQueue mqSelected = this.selectOneMessageQueue(topicPublishInfo, lastBrokerName);//确定向哪个mq发送消息，但是此时mq对应的是具体集群中broker还没有确定。
                if (mqSelected != null) {
                    mq = mqSelected;
        ...
        if (brokerAddr != null) {
            ...
            try {
                ...
                if (this.hasSendMessageHook()) {
                    context = new SendMessageContext();//消息上下文
                ...
                switch (communicationMode) {
                    case ASYNC:
                        ...
                        sendResult = this.mQClientFactory.getMQClientAPIImpl().sendMessage(
                            brokerAddr,//master的路径
                            mq.getBrokerName(),//集群名称
                            tmpMessage,
                            requestHeader,//包含queueId信息
