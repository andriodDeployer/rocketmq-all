...
//定时从nameServer上获取topic的信息
            ...
            public void run() {
                try {
                    MQClientInstance.this.updateTopicRouteInfoFromNameServer();//定时从nameServer上更新topic分布信息
                } catch (Exception e) {
...
//动态调整处理消息的线程池的大小
    ...
    public String findBrokerAddressInPublish(final String brokerName) {
        HashMap<Long/* brokerId */, String/* address */> map = this.brokerAddrTable.get(brokerName);//根据brokerName找到指定的集群信息。
        if (map != null && !map.isEmpty()) {
