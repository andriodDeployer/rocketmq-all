...
//总要有一个判断/分叉的操作。即使使用策略模式，因为客户端发送过来请求，都要在一个入口进行处理,这个入口一定要区分不同的请求。
        switch (request.getCode()) {//请求的类型
            ...
            case RequestCode.REGISTER_BROKER://注册路由信息
            ...
            case RequestCode.GET_ROUTEINTO_BY_TOPIC://客户端定时从NameServer获取路由信息
    ...
    public RemotingCommand registerBroker(ChannelHandlerContext ctx,
        ...
        } else {//重新new出来一个空的topicConfigWrapper的目的主要是为了，下面处理逻辑统一。
